...
@WebService(targetNamespace = "http://service.soa2_1.tix.org/", endpointInterface = "org.tix.soa2_1.service.TicketSoapProxyServiceInterface")
public class TicketSoapProxyService implements TicketSoapProxyServiceInterface {
    ...
    @Override
    @WebMethod
    public TicketForResponse getTicketById(@WebParam(name = "ticketId") Long ticketIdLong) {
    ...
    @WebMethod
    public void createTicket(@WebParam(name = "ticketData") TicketForUserDTO newTicket) {
